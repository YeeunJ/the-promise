      ...
      <div className="bg-white rounded-xl shadow-md border border-[#E5E7EB] overflow-hidden">
        <div className="px-6 py-5">
          ...
          <dl className="space-y-3">
            <div className="flex">
              <dt className="w-28 flex-shrink-0 text-sm text-accent">신청 번호</dt>
              <dd className="text-sm font-medium text-black">{reservation.id}</dd>
            </div>

            <div className="flex">
              <dt className="w-28 flex-shrink-0 text-sm text-accent">신청자 이름</dt>
              <dd className="text-sm font-medium text-black">{reservation.applicant_name}</dd>
            </div>

            <div className="flex">
              <dt className="w-28 flex-shrink-0 text-sm text-accent">단체명</dt>
              <dd className="text-sm font-medium text-black">{reservation.applicant_team}</dd>
            </div>

            <div className="flex">
              <dt className="w-28 flex-shrink-0 text-sm text-accent">공간</dt>
              <dd className="text-sm font-medium text-black">{spaceLabel}</dd>
            </div>

            <div className="flex">
              <dt className="w-28 flex-shrink-0 text-sm text-accent">날짜·시간</dt>
              <dd className="text-sm font-medium text-black">{datetimeLabel}</dd>
            </div>

            <div className="flex">
              <dt className="w-28 flex-shrink-0 text-sm text-accent">인원</dt>
              <dd className="text-sm font-medium text-black">{reservation.headcount}명</dd>
            </div>

            <div className="flex">
              <dt className="w-28 flex-shrink-0 text-sm text-accent">사용 목적</dt>
        ...
        <div className="px-6 pb-5">
          <button
            type="button"
            onClick={onReset}
            className="w-full py-2.5 px-4 bg-primary hover:bg-primary-dark active:bg-[#007A3D] text-white text-base font-bold rounded-xl transition-colors duration-150"
          >
            새 신청하기
          </button>
        </div>
